...
const GptSearchBar = () => {
  ...
  return (
    <div className="pt-50 md:p-24 flex justify-center w-full">
      <input 
        className='bg-gray-900 text-white  md:w-[50%] px-6 py-4 text-lg rounded-l-2xl border border-gray-600 placeholder-gray-400 outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300' 
        ref={searchText}
        type='text'
        placeholder={lang[langKey].gptPlaceholder}
      />
      <button className='bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 text-white px-4 md:px-8 py-0.5 md:py-4 text-lg font-semibold rounded-r-2xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 flex items-center' onClick={handleGptSearch}>
